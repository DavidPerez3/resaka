...
const styles = StyleSheet.create({
  card: { width: '100%', aspectRatio: 9 / 16, padding: 16, justifyContent: 'space-between', overflow: 'hidden', backgroundColor: '#0B0D12' },
  shade: { backgroundColor: 'rgba(5, 6, 10, 0.62)' },
  brand: { color: '#FFFFFF', fontSize: 24, fontWeight: '900', letterSpacing: 3 },
  tagline: { marginTop: 3, color: 'rgba(255,255,255,0.72)', fontSize: 8, fontWeight: '600' },
  headlineBlock: { marginTop: 8 },
  eyebrow: { color: '#E84A5F', fontSize: 8, fontWeight: '900', letterSpacing: 1.4 },
  headline: { marginTop: 8, color: '#FFFFFF', fontSize: 27, lineHeight: 29, fontWeight: '900' },
  date: { marginTop: 7, color: 'rgba(255,255,255,0.78)', fontSize: 10, fontWeight: '800' },
  routeCard: { height: 174, padding: 12, borderRadius: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.13)', backgroundColor: 'rgba(8,11,18,0.78)' },
  routeSvg: { marginTop: 5 },
  routeSpacer: { height: 88 },
  noRoute: { flex: 1, textAlign: 'center', textAlignVertical: 'center', color: 'rgba(255,255,255,0.68)', fontSize: 9, fontWeight: '700' },
  bottomBlock: { gap: 12 },
  statsCard: { minHeight: 70, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, gap: 9, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.13)', backgroundColor: 'rgba(8,11,18,0.82)' },
  stat: { flex: 1 },
  statLabel: { color: 'rgba(255,255,255,0.62)', fontSize: 6, fontWeight: '900', letterSpacing: 0.7 },
  statValue: { marginTop: 5, color: '#FFFFFF', fontSize: 12, fontWeight: '900' },
  sectionLabel: { color: 'rgba(255,255,255,0.65)', fontSize: 7, fontWeight: '900', letterSpacing: 1 },
  detail: { marginTop: 5, color: '#FFFFFF', fontSize: 9, lineHeight: 13, fontWeight: '800' },
  hashtag: { alignSelf: 'flex-end', color: '#E84A5F', fontSize: 9, fontWeight: '900' },
});
